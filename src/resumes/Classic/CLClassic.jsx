...
const CLClassic = () => {
    ...
    return (
        <div
            className={`w-[210mm] h-[297mm] mx-auto my-1 shadow-xl bg-${cp}-light px-8 py-12 text-sm space-y-24 text-${cp}-dark font-dm`}
        >
            {/* Head */}
            <div className="flex justify-between">
                <div>
                    <div
                        className={`text-${cp}-primary font-bold text-base font-lora`}
                    >
                        {d.head.fullName}
                    </div>
                    <ul className="">
